...
const Files = () => {
  ...
  function getDocuments(page, pageSize, sortParams, filterParams) {
    if (Object.keys(filterParams).length !== 0) {
      ...
      axios.get(`http://localhost:8091/documents/by`,
        {
          params: params,
          paramsSerializer: {
            indexes: null
        ...
        .then(res => {
          ...
          axios.get("http://localhost:8091/types")
            .then(res => {
      ...
      axios.get("http://localhost:8091/documents", {
        params: {
          page: page,
          pageSize: pageSize,
          ...sortParams
  ...
  function editDocument(e, fileId, title, idOfType, dateToPay, cost, paid) {
    ...
    axios.put(`http://localhost:8091/documents/${fileId}`, documentDTO)
      .then((res) => {
  ...
  function addNewType(e, typeName) {
    ...
    axios.post(`http://localhost:8091/types`, fileDTO)
      .then((res) => {
